...
\textbf{Wind}: $IG_{\text{Wind}} \approx 0.971 - 0.951 = \boxed{0.020} $
  ...
  \begin{aligncustom}
    H_{\text{Wind}} &= \frac{3}{5} \cdot \left( -\frac{1}{3}\log\left(\frac{1}{3}\right)  -\frac{2}{3}\log\left(\frac{2}{3}\right)\right) + \frac{2}{5} \cdot 1 \\
                    &\approx \frac{3}{5} \cdot 0.918  + \frac{2}{5} \\
                    &\approx 0.951
  \end{aligncustom}
...
\textbf{Wind}: $IG_{\text{Wind}} \approx 0.971 - 0 = \boxed{0.971} $
  ...
  \begin{aligncustom}
    H_{\text{Wind}} &= \frac{2}{5} \cdot 0 + \frac{3}{5} \cdot 0 \\
                    &= 0
  \end{aligncustom}
