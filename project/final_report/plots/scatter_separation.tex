...
%           legend pos=outer north east,
          ...
          \addplot[
                     ...
                     only marks,
                     scatter/classes={
                        1={mark=square*,color=black,very thin,mark size=1.65pt,fill opacity=0.5,{fill=red}},
                        2={mark=triangle*,fill opacity=0.5,color=black,mark size=2.4pt,{fill=ForestGreen}},
                        0={mark=o,blue}
                     },
                     mark size=2pt
                   ]
